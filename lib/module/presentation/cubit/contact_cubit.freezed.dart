...
mixin _$ContactState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Map<String, String>> data) success,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Map<String, String>> data)? success,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Map<String, String>> data});
}
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({required final List<Map<String, String>> data})
      : _data = data;
  ...
  @override
  String toString() {
    return 'ContactState.success(data: $data)';
  }
...
abstract class _Success implements ContactState {
  const factory _Success({required final List<Map<String, String>> data}) =
      _$SuccessImpl;
